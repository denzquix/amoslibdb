...
namespace GUI {
  ...
  export const V1_61 = {
    ...
    type: 'pro',
    extends: V1_50B,
    removed: ['GuiCircle', 'GuiScreenOpen'],
    routines: {
      GuiActivate: 106,
      GuiBeep: 60,
      GuiClw: 113,
  ...
  export const V2_00 = {
    ...
    removed: ['GuiAmiga', 'GuiAmos', 'GuiAslOpen_I', 'GuiAslOpen_ISI', 'GuiScreenOpen_IIIII', 'GuiScreenOpen_IIIIISI', 'GuiSet',
      'TcpAddress','TcpBuffer','TcpChannel','TcpCheck','TcpCode','TcpCount','TcpFOpen','TcpFree','TcpGet','TcpLimit','TcpLine','TcpPacket','TcpPut_III',
      'TcpPut_IS','TcpRead','TcpRemove','TcpReset','TcpSave','TcpSend_IIII','TcpSend_ISI','TcpSignal','TcpTime','TcpTrash','TcpType',
    ],
    extends: V1_75,
    routines: {
      GuiAmigaOs: 5,
